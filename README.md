...
📝 **_Notes_**: "--sparsity_percentage 0.1" means "$s=0.1$" in Eq. (3) (However, the actual sparsity may differ from $s$. When changing the random seed, **we do not adjust “sparsity_percentage” based on test-set sparsity, as BINGO is designed to adaptively balance different objectives.**). 
